			...
			<div className="container mx-auto px-6 lg:px-8 max-w-7xl">
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
					...
					<div className="lg:col-span-8">
						<h2 className="font-display text-2xl font-normal mb-6 flex items-center gap-3 tracking-tight">
							...
							<div className="space-y-4">
								{customer.orders.edges.map((edge: any) => {
									...
									return (
										<div
											key={order.id}
											className="bg-secondary/20 rounded-[1.5rem] p-6 lg:p-8 flex flex-col sm:flex-row justify-between sm:items-center gap-6 border border-border/40 hover:border-foreground/20 transition-colors group"
										>
											<div>
											...
											<div className="flex items-center gap-6 sm:text-right">
												...
												<Button
													variant="outline"
													size="icon"
													className="w-12 h-12 rounded-full border-border/60 bg-background group-hover:bg-foreground group-hover:text-background group-hover:border-foreground transition-all duration-[160ms]"
												>
